...
ActiveRecord::Schema[8.1].define(version: 2026_09_22_160000) do
  ...
  create_table "generations", force: :cascade do |t|
    ...
    t.string "image_model", default: "gemini-3-pro-image-preview", null: false
    t.text "input_text"
    t.string "input_url"
    ...
    t.index ["prospect_id"], name: "index_generations_on_prospect_id"
  ...
  create_table "prospects", force: :cascade do |t|
    ...
    t.datetime "contacts_requested_at"
    t.text "contacts_research"
    t.datetime "contacts_researched_at"
    t.text "conversation"
    t.datetime "created_at", null: false
    t.string "email"
    ...
    t.index ["next_action_on"], name: "index_prospects_on_next_action_on"
  ...
  add_foreign_key "generations", "prospects", on_delete: :nullify
