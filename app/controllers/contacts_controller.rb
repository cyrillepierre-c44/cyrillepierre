...
class ContactsController < ApplicationController
  ...
  REALISATIONS = [
    ...
    { id: "N°16",
      ...
      tags: %w[agro management formation chefs-équipe alignement-terrain coordination-équipes DDS animation-terrain IRP développement-managers coaching management-de-proximité] },
    { id: "N°17",
